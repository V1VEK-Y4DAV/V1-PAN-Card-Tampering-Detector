...
def index():
    ...
    if request.method == "POST":
        ...
        # resize and save the original image to ensure both uploaded and original image matches in size
        ...
        thresh = cv2.threshold(diff, 0, 255, cv2.THRES_BINARY_INV | cv2.THRESH_OTSU)[1]
        ...
        for c in cnts:
            ...
            cv2.rectangle(uploaded_image, (x, y), (x + w, w + h), (0, 0, 255), 2)
